...
const IconSteam = (p) => <Icon {...p} fill="currentColor" stroke="none" viewBox="0 0 24 24"><path fillRule="evenodd" clipRule="evenodd" d="M12 2C6.477 2 2 6.477 2 12c0 4.418 2.865 8.166 6.839 9.489L7.393 17.44a2.5 2.5 0 1 1 2.278-1.772l1.761-.733A3.5 3.5 0 1 0 15 11.5l-2.424 3.462a2.5 2.5 0 0 0-2.083 2.538l1.507 4.43A10 10 0 1 1 12 2zm3.5 5a2 2 0 1 1 0 4 2 2 0 0 0 0-4zm-7 7.5a1.5 1.5 0 1 0 0 3 1.5 1.5 0 0 0 0-3z"/></Icon>;
